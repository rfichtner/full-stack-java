...
public class PicturesView extends VerticalLayout implements HasTitle
{
	...
	private void button_onClick(final ClickEvent<Button> event)
	{
		...
		final Pizza p = new Pizza(this.txtMenuId.getValue(), this.txtName.getValue(),
			this.nrCalories.getValue().intValue(), this.txtdescription.getValue());
	...
	private void initUI()
	{
		...
		this.binder.forField(this.txtdescription).withNullRepresentation("").bind(Pizza::getdescription, (v, x) -> {});
	...
	private Label         lblMenuId, lblName, lblCalories, lbldescription;
	private Binder<Pizza> binder;
	private TextField     txtMenuId, txtName, txtdescription;
